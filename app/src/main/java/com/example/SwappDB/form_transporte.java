...
public class form_transporte extends AppCompatActivity implements View.OnClickListener {

    private EditText valor; //variable valor
    private EditText nota; //variable  nota
    private EditText fecha; //variable  fecha
    private Button transporte_guardar; //variable guardar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_transporte);
        ...
        transporte_guardar = (Button) findViewById(R.id.transporte_guardar);
        transporte_guardar.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.transporte_guardar: //caso para devolver al home
                if (!validate()) {
                    return;
                }
    ...
    private boolean validate() {
        ...
        if (numFact.getText().toString().equals("")) {
            ...
            InputMethodManager imm = (InputMethodManager) getSystemService(form_transporte.INPUT_METHOD_SERVICE);

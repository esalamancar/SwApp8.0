...
public class form_extra extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button extra_guardar; //variable boton de guardar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_extra);
        ...
        extra_guardar = (Button) findViewById(R.id.extra_guardar);
        extra_guardar.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.extra_guardar: //caso para devolver al home
                ...
                enviar.TransaccionEnvio("Ingresos", idfijo, sbanco, scategoria, sfecha, snota, svalor, stipo);
    ...
    private boolean validate() {
        ...
        if (banco.getText().toString().equals("")) {
            ...
            // Focus
            banco.requestFocus();
            InputMethodManager imm = (InputMethodManager) getSystemService(form_extra.INPUT_METHOD_SERVICE); imm.showSoftInput(banco, 0); //Activar teclado
            return false;
        } else {
            if (valor.getText().toString().equals("")) {
                ...
                // Focus
                valor.requestFocus();
                InputMethodManager imm = (InputMethodManager) getSystemService(form_extra.INPUT_METHOD_SERVICE); imm.showSoftInput(valor, 0); //Activar teclado
                return false;
            } else {
                if (nota.getText().toString().equals("")) {
                    ...
                    // Focus
                    nota.requestFocus();
                    InputMethodManager imm = (InputMethodManager) getSystemService(form_extra.INPUT_METHOD_SERVICE); imm.showSoftInput(nota, 0); //Activar teclado
                    return false;
                    ...
                    if (fecha.getText().toString().equals("")) {
                        ...
                        // Focus
                        fecha.requestFocus();
                        InputMethodManager imm = (InputMethodManager) getSystemService(form_extra.INPUT_METHOD_SERVICE); imm.showSoftInput(fecha, 0); //Activar teclado
                        return false;
                    } else {
                        return true;
                    }

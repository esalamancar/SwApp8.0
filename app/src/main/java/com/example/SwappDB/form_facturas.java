...
public class form_facturas extends AppCompatActivity implements View.OnClickListener {


    private EditText valor; //variable valor
    private EditText nota; //variable  nota
    private EditText fecha; //variable  fecha
    private Button factura_guardar; //variable guardar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_facturas);
        factura_guardar = (Button) findViewById(R.id.factura_guardar);
        factura_guardar.setOnClickListener(this);
        ...
        categ = (TextView) findViewById(R.id.factura);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.factura_guardar: //caso para devolver al home
                if (!validate()) {
                    return;
                }
    ...
    private boolean validate () {
        ...
        if (numFact.getText().toString().equals("")) {
            ...
            InputMethodManager imm = (InputMethodManager) getSystemService(form_facturas.INPUT_METHOD_SERVICE); imm.showSoftInput(numFact, 0); //Activar teclado
            return false;
        } else {
            if (valor.getText().toString().equals("")) {
                ...
                // Focus en jugar y abrir el Teclado
                valor.requestFocus();
                InputMethodManager imm = (InputMethodManager) getSystemService(form_facturas.INPUT_METHOD_SERVICE); imm.showSoftInput(valor, 0); //Activar teclado
                return false;
            } else {
                if (nota.getText().toString().equals("")) {
                    ...
                    // Focus en jugar y abrir el Teclado
                    nota.requestFocus();
                    InputMethodManager imm = (InputMethodManager) getSystemService(form_facturas.INPUT_METHOD_SERVICE); imm.showSoftInput(nota, 0);
                    return false;
                    ...
                    if (fecha.getText().toString().equals("")) {
                        ...
                        // Focus en jugar y abrir el Teclado
                        fecha.requestFocus();
                        InputMethodManager imm = (InputMethodManager) getSystemService(form_facturas.INPUT_METHOD_SERVICE); imm.showSoftInput(fecha, 0);
                        return false;
                    } else {
                        return true;
                    }

...
public class form_salario extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button salario_guardar; //variable boton de guardar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_salario);
        ...
        salario_guardar = (Button) findViewById(R.id.salario_guardar);
        salario_guardar.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.salario_guardar: //caso para devolver al home
                ...
                MainActivity iduser =new MainActivity();
                iduser.getTextemail();
                ...
                enviar.TransaccionEnvio("Ingresos", "swappseminario@gmailcom", sbanco, scategoria, sfecha, snota, svalor, stipo);
    ...
    private boolean validate() {
        ...
        if (banco.getText().toString().equals("")) {
            ...
            // Focus
            banco.requestFocus();
            InputMethodManager imm = (InputMethodManager) getSystemService(form_prestamo.INPUT_METHOD_SERVICE);
            imm.showSoftInput(banco, 0); //Activar teclado
            return false;
        } else {
            if (valor.getText().toString().equals("")) {
                ...
                if (nota.getText().toString().equals("")) {
                    ...
                    nota.requestFocus();
                    InputMethodManager imm = (InputMethodManager) getSystemService(form_prestamo.INPUT_METHOD_SERVICE);
                    imm.showSoftInput(nota, 0); //Activar teclado
                    return false;
                    ...
                    if (fecha.getText().toString().equals("")) {
                        ...
                        fecha.requestFocus();
                        InputMethodManager imm = (InputMethodManager) getSystemService(form_prestamo.INPUT_METHOD_SERVICE);
                        imm.showSoftInput(fecha, 0); //Activar teclado
                        return false;
                    } else {
                        return true;
                    }
